...
from reading_section import get_page_link
from reading_section import get_passage_link
from reading_section import get_passage_content
...
def test_get_passage_link():
    ...
    expect_data = {
        "Official 54 Passage 1": "https://toefl.kmf.com/detail/read/11m4mj.html/1",
        "Official 53 Passage 1": "https://toefl.kmf.com/detail/read/a1m4jj.html/1",
        "Official 53 Passage 3": "https://toefl.kmf.com/detail/read/b1m4lj.html/1",
        "Official 51 Passage 1": "https://toefl.kmf.com/detail/read/e1m36j.html/1",
    }
    assert get_data == expect_data


def test_get_passage_content():
    get_data = get_passage_content("https://toefl.kmf.com/detail/read/11m4mj.html/1")
    expect_data = [
